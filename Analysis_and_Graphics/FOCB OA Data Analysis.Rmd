...
than  the observed annual average temperature We use 2 degrees C only for
...
looking at percent saturation. Temperature show strong bimodal distribution,
...
# Summary Statistics
# Entire Data Set
This is legacy code. It would be easier today to develop this directly in the 
tidyverse.
```{r summary_stats}
...
further in the another R Notebook in the "Analysis" folder.
